    ...
    function TwitThread(config) {
        ...
        _this.tweet = function (text, options) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (twitterText_1.default.parseTweet(text).weightedLength > TWEET_MAX_LENGTH)
                    ...
                    case 1:
                        data_1 = (_a.sent()).data;
                        mediaData = data_1.media_id_string;
                        _a.label = 2;
        ...
        _this.howManyTimesTweetHasBeenTrimmed = function (tweet) {
            return Math.floor(tweet.length / tweetMax_1.TWEET_MAX_LENGTH);
        };
        _this.trimmer = new Trimmer_1.default(tweetMax_1.TWEET_MAX_LENGTH);
        return _this;
    }
    return TwitThread;
}(twit_1.default));
